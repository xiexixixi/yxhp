  ...
  return (
    <Project>
      ...
      <ButtonContainer display={props.demoLink == null || "" ? String("none") : String("")}>
        <a href={props.demoLink} className="btn demo__link" target="_blank" rel="noreferrer">
          Demo
        </a>
        {!!props.sourceLink && (
          <a href={props.sourceLink} className="btn source__link" target="_blank" rel="noreferrer">
            Github
          </a>
        )}
      </ButtonContainer>
